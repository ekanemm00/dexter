    ...
    return (
        <main className="min-h-screen flex justify-center px-2 md:py-23 md:px-12 lg:py-15 lg:px-16">
            <div className="w-full py-10 px-2 md:w-[350px] h-auto shadow-md rounded-md md:py-10 md:px-4">
                ...
                <h1 className="text-lg font-semibold text-center text-gray-800">Ekanem Michael</h1>
                    ...
                    <div className="mt_5">
                        <p className="border-b border-gray-300 text-lg text-center">ekanemmichael777@gmail.com</p>
